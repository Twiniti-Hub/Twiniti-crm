...
For the full Resend dashboard checklist (DNS, MX receiving, webhook URL + secret, troubleshooting 401 and empty timelines), see [Resend email setup](../operations/RESEND_EMAIL_SETUP.md).
