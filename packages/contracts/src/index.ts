...
export const regionCodeSchema = z.enum(["eu", "uk", "us"]);
...
const COUNTRY_CODE_SET = new Set<string>(countryCodeOptions);

export const countryCodeSchema = z.string().trim().toUpperCase().refine((value) => COUNTRY_CODE_SET.has(value), {
